...
function template_load_the_scripts(){
	template_load_background('business');
}
...
function template_do_caption(){
	template_do_home_caption($home_page, 'Business Admin Slideshow Caption');
}
...
function template_do_sidebar(){
		template_do_degrees();
		template_do_spotlight_sidebar(28);
}
...
function template_do_title(){
	?> <div class="tab-title"><h1><a href="<?php echo get_permalink(382); ?>"><?php echo get_the_title(382); ?></a></h1></div><?php
}
