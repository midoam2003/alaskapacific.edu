...
function template_load_the_scripts(){
	template_load_background('education');
}


add_action('genesis_before_content_sidebar_wrap', 'template_do_caption');
function template_do_caption(){
	template_do_home_caption($home_page, 'Education Slideshow Caption');
}
...
function template_do_sidebar(){
		template_do_degrees();
		template_do_spotlight_sidebar(22);
}
...
function template_do_title(){
	?> <div class="tab-title"><h1><a href="<?php echo get_permalink(386); ?>"><?php echo get_the_title(386); ?></a></h1></div><?php
}
