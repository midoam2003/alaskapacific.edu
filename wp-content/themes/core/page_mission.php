...
function section_do_title(){
	?> <div class="tab-title"><h1><a href="<?php echo get_bloginfo('url'); ?>/about-apu/mission-goals/">Mission &amp; Goals</a></h1></div><?php
}
