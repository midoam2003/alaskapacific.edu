...
// Template Name: Nordic Ski Center
...
function section_do_title(){
	?> <div class="tab-title"><h1><a href="<?php echo get_bloginfo('url'); ?>/explore-apu/nordic-ski-center/">Nordic Ski Center</a></h1></div><?php
}
