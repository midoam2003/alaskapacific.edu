...
function section_do_title(){
	?> <div class="tab-title"><h1><a href="<?php echo get_bloginfo('url'); ?>/explore-apu/student-life/">Student Life</a></h1></div><?php
}
...
function template_load_mobile(){
	load_main_menu();
	load_page_menu('student-life-menu');
	load_quick_links();
}
