...
function section_do_title(){
	?> <div class="tab-title"><h1><a href="<?php echo get_bloginfo('url'); ?>/about-apu/at-a-glance/">At A Glance</a></h1></div><?php
}
...
function template_load_mobile(){
	load_main_menu();
	load_page_menu('at-a-glance-menu');
	load_quick_links();
}
