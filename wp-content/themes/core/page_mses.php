...
function template_after_post_content(){
	template_home_after_post_content(6739, 109);
}
...
function section_do_title(){
	?> <div class="tab-title"><h1><a href="<?php echo get_permalink(6739); ?>"><?php echo get_the_title(6739); ?></a></h1></div><?php
}
