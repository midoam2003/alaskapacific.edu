...
// Template Name: Masters of Business Administration
...
function template_do_sidebar_menu(){
	template_do_dept_sidebar_menu('mba-menu');
}
...
function template_do_sidebar(){
		template_do_spotlight_sidebar(65);
}
...
function template_after_post_content(){
	template_home_after_post_content(2531, 65);
}

//Add in the degree header tab
add_action('genesis_before_content_sidebar_wrap', 'section_do_title', 20);
function section_do_title(){
	?> <div class="tab-title"><h1><a href="<?php echo get_permalink(2531); ?>"><?php echo get_the_title(2531); ?></a></h1></div><?php
}
