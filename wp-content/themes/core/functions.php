...
function child_do_header(){ ?>
	 ...
	 <?php do_action( 'genesis_site_description' ); ?>
	 </div><!-- end #title-area -->
...
function child_do_sidebar(){
	?>
		...
		<div class="widget"><!-- BEGIN LivePerson Button Code --><a href='http://server.iad.liveperson.net/hc/17642027/?cmd=file&file=visitorWantsToChat&site=17642027&byhref=1&imageUrl=<?php echo get_bloginfo('url'); ?>/content/themes/core/images/' target='chat17642027'  onClick="lpButtonCTTUrl = 'http://server.iad.liveperson.net/hc/17642027/?cmd=file&file=visitorWantsToChat&site=17642027&imageUrl=<?php echo get_bloginfo('url'); ?>/content/themes/core/images/&referrer='+escape(document.location); lpButtonCTTUrl = (typeof(lpAppendVisitorCookies) != 'undefined' ? lpAppendVisitorCookies(lpButtonCTTUrl) : lpButtonCTTUrl); lpButtonCTTUrl = ((typeof(lpMTag)!='undefined' && typeof(lpMTag.addFirstPartyCookies)!='undefined')?lpMTag.addFirstPartyCookies(lpButtonCTTUrl):lpButtonCTTUrl);window.open(lpButtonCTTUrl,'chat17642027','width=475,height=400,resizable=yes');return false;" >
