...
// Template Name: Moseley Sports Center
...
function section_do_title(){
	?> <div class="tab-title"><h1><a href="<?php echo get_bloginfo('url'); ?>/explore-apu/moseley-sports-center/">Moseley Sports Center</a></h1></div><?php
}
