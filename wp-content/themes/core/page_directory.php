...
function template_do_content(){
			...
			<div id="tabs-offices">
				<?php
					...
					if($wp_query->have_posts()) : while($wp_query->have_posts()) : $wp_query->the_post();
						...
						$people_title = (isset($custom_fields['title'][0]) ? $custom_fields['title'][0] : null);
						$people_phone = (isset($custom_fields['phone'][0]) ? $custom_fields['phone'][0] : null);
						$people_email = (isset($custom_fields['email'][0]) ? $custom_fields['email'][0] : null);
						$people_resume = (isset($custom_fields['resume'][0]) ? $custom_fields['resume'][0] : null);
		...
		<?php 
			if((isset($_GET['search']) ? $_GET['search'] : null)){ echo '{ selected: 2 }';}
		?>
		);
		});
		</script>
