...
function stag_general_settings(){
  ...
  $general_settings[] = array(
    ...
    $general_settings[] = array(
        'title' => __('Post Excerpt Length', 'stag'),
        'desc'  => __('Enter the length of post excerpt for blog page.', 'stag'),
        'type'  => 'text',
    ...
    $general_settings[] = array(
        'title' => __('Post Excerpt Text', 'stag'),
        'desc'  => __('Enter the length of post excerpt for blog page.', 'stag'),
        'type'  => 'text',
    ...
    $general_settings[] = array(
        'title' => __('Blog Pagination Option', 'stag'),
        'desc'  => __('Choose the pagination style.', 'stag'),
        'type'  => 'select',
        'id'    => 'general_pagination_option',
        'val'   => 'load-more',
        'options' => array(
            'load-more' => __('Load More', 'stag'),
            'prev-next' => __('Prev/Next', 'stag')
        )
    );
